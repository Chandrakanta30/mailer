                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="card card-primary">
                            ...
                            <form action="{{ route('smtp.update', $smtp->id) }}" id="loginform" class="login-form"
                                method="POST">
                                @csrf
                                @method('PUT')
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="password" name="password" class="form-control"
                                            id="exampleInputPassword1" placeholder="Password" value="{{ $smtp->password }}">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="from_mail" class="form-control"
                                            id="exampleInputPassword1" placeholder="Password"
